using QuảnLýQuánCafe.DAO;
using QuảnLýQuánCafe.DTO;
using System;
...
namespace QuảnLýQuánCafe
{
    public partial class fTableManager : Form
    {
        ...
        {
            lsvBill.Items.Clear();
            List<QuảnLýQuánCafe.DTO.Menu> listBillInfo = MenuDAO.Instance.GetListMenuByTable(id);
            float totalPrice = 0;
            foreach (QuảnLýQuánCafe.DTO.Menu item in listBillInfo)
            {
